...
public interface BeerRepository extends JpaRepository<Beer, UUID> {
    ...
    Page<Beer> findAllByBeerName(String beerName, String beerStyle, PageRequest pageRequest);

    Page<Beer> findAllByBeerStyle(String beerName, String beerStyle, PageRequest pageRequest);
